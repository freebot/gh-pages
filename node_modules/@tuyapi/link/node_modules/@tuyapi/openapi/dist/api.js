...
class OpenAPI {
    constructor({ key, secret, schema, region = 'us' }) {
        this.tokenAccess = '';
        this.tokenRefresh = '';
        ...
        this._client = got_1.default.extend({
            ...
            hooks: {
                beforeRequest: [options => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (this.tokenAccess === '') {
                        ...
                        sign = crypto.createHmac('sha256', this._secret).update(`${this._key}${this.tokenAccess}${now}`).digest('hex').toUpperCase();
    ...
    putUser({ countryCode, username, password, usernameType, nickname }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield this._client.post(`apps/${this.schema}/user`, {
                json: req
            });
            const { uid } = res.body;
            return uid;
    ...
    getUsers({ pageNumber, pageSize } = { pageNumber: 1, pageSize: 100 }) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield this._client.get(`apps/${this.schema}/users`, {
                searchParams: {
                    page_no: pageNumber,
                    page_size: pageSize
                }
    ...
    getDeviceToken({ uid, timezone }) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield this._client.post('devices/token', {
                json: {
                    uid,
                    timeZoneId: timezone
                }
    ...
    getDevicesByToken(token) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield this._client.get(`devices/tokens/${token}`);
            return res.body;
        });
    }
    getDevices(ids) {
